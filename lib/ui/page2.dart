import 'dart:convert';
import 'package:apidars40/ui/page3.dart';
...
class ViewPage extends StatefulWidget {
  ...
  String name;
  String cityname;
  ViewPage({required this.img, required this.name, required this.cityname});
  @override
              ...
              child: Column(
                ...
                children: [
                  ...
                  FutureBuilder(
                      future: getWeather(),
                      builder:
                          (context, AsyncSnapshot<Map<String, String>> snap) {
                        var data = snap.data;
                        return Padding(
